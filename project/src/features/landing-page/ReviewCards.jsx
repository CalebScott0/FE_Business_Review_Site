...
import { AppleIcon, CircleUser, Star, StarHalf } from "lucide-react";
...
const ReviewCards = () => {
  ...
  if (reviews.length > 0) {
    return (
      <section className="ml-12 mt-24 grid grid-cols-5 items-center gap-2 gap-x-0">
        {reviews.map((review) => (
          <Card
            className="box-border h-fit w-full max-w-[250px] animate-bounce shadow-lg"
            key={review.id}
          >
            <CardHeader>
